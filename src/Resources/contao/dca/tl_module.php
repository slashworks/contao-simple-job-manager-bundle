...
$GLOBALS['TL_DCA']['tl_module']['fields']['jumpTo']['eval']['tl_class'] = $GLOBALS['TL_DCA']['tl_module']['fields']['jumpTo']['eval']['tl_class'] . ' clr';
...
Class tl_module_dca
{
    ...
    public function adjustDcaByType($dc)
    {
        ...
        {
            case 'job-list':
                $GLOBALS['TL_DCA']['tl_module']['fields']['jumpTo']['eval']['tl_class'] = $GLOBALS['TL_DCA']['tl_module']['fields']['jumpTo']['eval']['tl_class'] . ' clr w50';
                break;
